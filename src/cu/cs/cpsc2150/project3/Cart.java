...
/**
 * The cart class stores all the books that are processed during a checkout
 * transaction. Utilizes an observer collection to perform the approprate action
 * for each of the books in the cart.
 * 
 * @author Andrew
 *
 */
