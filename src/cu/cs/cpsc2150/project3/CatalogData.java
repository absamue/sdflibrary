...
/**
 * The CatalogData class provides storage for a series of books that are
...
public class CatalogData {
	...
	/**
	 * CatalogData() will build the array list by reading from disk the stored
	 * list. Does nothing if file is not found.
	 */
	...
	/**
	 * save() will write the userData arraylist to disk in the file
	 * catalogData.ser.
	 */
	public void save() {
	...
	/**
	 * putBook(Book in) will add the given book to the end of the list. The new
	 * list will then be saved to disk.
	 * 
	 * @param in
	 *            Book to add to list.
	 */
	 ...
	 * 
	 * @param title
	 *            Title of book to find.
	 * @return Returns book with matching title if found, otherwise returns
	 *         null.
	 */
	...
	/**
	 * updateBook(Book old, Book nw) will replace the book at index of old with
	 * the updated version contained in nw.
	 * 
	 * @param old
	 *            Book to be replaced with updated data.
	 * @param nw
	 *            Book to replace old item.
	 */
	...
	/**
	 * checkTitle(Book in) will check if a book with the same title as in exists
	 * in the catalog.
	 * 
	 * @param in
	 *            Book to check if title is present
