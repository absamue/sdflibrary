...
/**
 * The ReturnObserver class provides an observer to return a checked out book to the catalog.
 * @author Andrew
 *
 */
public class ReturnObserver implements Observer {
	...
	/**
	 * doNotify() will perform the return action by changing the status of the book
	 * and then updating the database and tables.
	 */
	@Override
