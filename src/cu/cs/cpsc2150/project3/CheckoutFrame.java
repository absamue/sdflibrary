...
public class CheckoutFrame extends JFrame {
	...
	public void initialize() {
			...
			public void mouseClicked(MouseEvent e) {
				if (e.getClickCount() == 2) {
					...
					if (row != -1) {
						...
						cancelBooks.add(sel); // list of books to add back to
												// user if cancelled
		...
		// open a frame containing the catalog, that allows selecting a book to
		// check out
		...
		// places all uncomplete cart books back where they belong, and hides
		// frame
		...
		cancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// cancel all the observers so none of them fire at later
				// transaction
